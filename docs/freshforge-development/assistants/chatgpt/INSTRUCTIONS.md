# ChatGPT Project Instructions — FreshForge

> **Copy everything inside the block below** into your ChatGPT Project → **Instructions**.  
...
| Prep a Cursor prompt | Give a clear managed-phase or skill alias prompt |
...
- Large changes belong in Cursor via FreshForge managed phases — help me phrase the work.
