...
> How FreshForge is developed, exported, and installed as a clean workflow starter.

---

The GitHub repository may include development tooling, CI, and `docs/freshforge-development/`. The **starter surface** — the product installed by default — is defined in `docs/freshforge-development/distribution/STARTER_SURFACE.md`.
...
| | FreshForge development repo (this GitHub repo) | Target project after default install |
|--|---------------------------------------------|--------------------------------------|
| Purpose | Build and maintain FreshForge | Run agent-driven development in your app |
| `docs/freshforge-development/` | Maintainer plans, reviews, signoffs | **Not copied** |
...
| `README.md` | Full FreshForge documentation | Optional via `--include-readme` (as `FRESHFORGE_README.md` on install) |
...
- **Install:** `--include-readme` → `FRESHFORGE_README.md` (preserves target `README.md`)
...
| `dist/`, `freshforge-temp/`, `tmp-install-test/` | Local export and test folders |

---

## Export a Clean Starter

From the FreshForge development repository:

```bash
# Default export → dist/freshforge-starter/
...
1. **Inspect folder structure:**
   ...
   ```text
   dist/freshforge-starter/
     AGENTS.md
     .cursor/
     docs/          (no freshforge-development/)
   ```

2. **Confirm exclusions:** no `node_modules/`, `.git/`, `docs/freshforge-development/`, or env files.
...
2. Archive completed managed-phase artifacts under `docs/freshforge-development/`.
...
## Why `docs/freshforge-development/` Stays in the Development Repo Only

This folder records FreshForge maintenance history: completed plans, reviews, test reports, and signoffs from building the starter itself. Target application projects should not receive this context — they start with clean `docs/workflow/plans/` and `docs/workflow/reviews/` for their own work.

Install and export scripts **always exclude** `docs/freshforge-development/`.

### Clean workflow state

The FreshForge **development repo** uses `.cursor/workflow/state.md` during Managed Phases and may contain phase history, decision logs, and signoff status.
...
- `docs/freshforge-development/distribution/STARTER_SURFACE.md` — starter surface definition (installed product)
- `docs/freshforge-development/distribution/INSTALLATION.md` — end-user install workflows
- `docs/freshforge-development/distribution/PACKAGING.md` — manual cleanup and packaging checklist
...
| 2026-06-23 | Added starter surface definition reference (`docs/freshforge-development/distribution/STARTER_SURFACE.md`) |
