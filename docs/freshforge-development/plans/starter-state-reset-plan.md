...
| Related | docs/freshforge-development/reviews/starter-state-reset-review.md |

---

## Goal

Ensure install and export never ship FreshForge development workflow history in `.cursor/workflow/state.md`. Targets always receive clean idle state from `state-template.md`.
