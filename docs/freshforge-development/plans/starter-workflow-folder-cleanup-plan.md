...
- Archive plan/signoff to `docs/freshforge-development/` (starter workflow folders stay clean)

## Out of scope

- `docs/freshforge-development/` layout (except reference clarifications)
...
6. Signoff in `docs/freshforge-development/reviews/`
...
- Inspect `dist/freshforge-starter/docs/workflow/`

## Risks

- Accidental replacement of `docs/freshforge-development/plans/` — mitigated by exact `docs/plans/` prefix only
