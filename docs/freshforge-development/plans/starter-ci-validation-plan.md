...
| Related | docs/freshforge-development/reviews/starter-ci-validation-review.md |

---

## Goal

Add lightweight, low-maintenance validation so the FreshForge workflow starter can verify required structure, markdown formatting, and internal markdown links locally and in CI.
...
- `scripts/validate-structure.mjs` — required FreshForge files and folders
...
## Approval
- Review doc: docs/freshforge-development/reviews/starter-ci-validation-review.md
- Verdict: pending
