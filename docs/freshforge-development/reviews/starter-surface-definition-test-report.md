...
| Assertion | Result |
|-----------|--------|
| `docs/freshforge-development/distribution/STARTER_SURFACE.md` exists | Pass |
| Default export roots: `AGENTS.md`, `.cursor/`, `docs/` | Pass |
| `docs/freshforge-development/distribution/STARTER_SURFACE.md` in export | Pass |
| `docs/freshforge-development/` excluded from export | Pass |
