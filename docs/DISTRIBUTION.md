...
4. **Run development-repo validation:**
...
5. Run `npm run validate` before push.
6. Do **not** commit `node_modules/` or `dist/` (export output is local unless you intentionally release artifacts).
