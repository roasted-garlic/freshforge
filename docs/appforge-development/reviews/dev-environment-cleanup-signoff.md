...
Not present: `build/`, `coverage/`, `.cache/`, `.tmp/`, `temp/`, `tmp/`, `tmp-install-test/`, `appforge-temp/`, `appforge-starter/`, `logs/`, archives, log files.
...
No changes required. Already includes `node_modules/`, `dist/`, env files, logs, archives, temp folders, and AppForge local output paths.
...
- Excludes `node_modules/`, `docs/appforge-development/`
